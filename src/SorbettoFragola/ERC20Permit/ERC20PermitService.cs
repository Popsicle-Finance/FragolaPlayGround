...
using SorbettoFragola.Contracts.ERC20Permit.ContractDefinition;

namespace SorbettoFragola.Contracts.ERC20Permit
{
    public partial class ERC20PermitService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC20PermitDeployment eRC20PermitDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC20PermitDeployment eRC20PermitDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC20PermitDeployment>().SendRequestAsync(eRC20PermitDeployment);
        }

        public static async Task<ERC20PermitService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC20PermitDeployment eRC20PermitDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public ERC20PermitService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
