...
using SorbettoFragola.Contracts.IWETH9.ContractDefinition;

namespace SorbettoFragola.Contracts.IWETH9
{
    public partial class IWETH9Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IWETH9Deployment iWETH9Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IWETH9Deployment>().SendRequestAndWaitForReceiptAsync(iWETH9Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IWETH9Deployment iWETH9Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IWETH9Deployment>().SendRequestAsync(iWETH9Deployment);
        }

        public static async Task<IWETH9Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IWETH9Deployment iWETH9Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iWETH9Deployment, cancellationTokenSource);
            return new IWETH9Service(web3, receipt.ContractAddress);
        }
        ...
        public IWETH9Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
